...
def get_args():
    ...
    parser.add_argument('--demo', default=None, action='store_true',
                        help='Run all demonstration tasks')
    ...
    assert not (args.demo and
                ( args.rotors
                or args.reflector
                or args.ring_settings
                or args.initial_positions
                or args.plugboard_pairs)) \
        , 'Cannot call --demo with other args, please use --demo only.'

    if not (args.demo or args.codebreaker):
